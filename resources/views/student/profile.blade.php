                    ...
                    <form action="{{route('student')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ Auth::user()->surname }}" readonly>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input id="role" type="text" class="form-control @error('role') is-invalid @enderror" name="role" value="{{ Auth::user()->role }}" readonly>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input id="telephone" type="text" class="form-control @error('telephone') is-invalid @enderror" name="telephone" value="{{ Auth::user()->role }}" required>
                            ...
                            <div class="col-md-6">
                                <label for="nif" class="col-form-label">{{ __('Nif') }}</label>
                                <input id="nif" type="text" class="form-control @error('nif') is-invalid @enderror" name="nif" value="{{ Auth::user()->nif }}" readonly>
